...
if (!process.env.MONGO_SERVICE_HOSTNAME) {
	console.log("MONGO_SERVICE_HOSTNAME not defined");
	process.exit(1);
} else {
	console.log("MONGO_SERVICE_HOSTNAME     : " + process.env.LOG_DIR);
}
...
var url = 'mongodb://' + process.env.MONGO_SERVICE_HOSTNAME + ':27017/my_database_name';
